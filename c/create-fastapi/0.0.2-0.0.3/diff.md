# Comparing `tmp/create_fastapi-0.0.2.tar.gz` & `tmp/create-fastapi-0.0.3.tar.gz`
...
## Comparing `create_fastapi-0.0.2.tar` & `create-fastapi-0.0.3.tar`
...
### Comparing `create_fastapi-0.0.2/LICENSE` & `create-fastapi-0.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `create_fastapi-0.0.2/pyproject.toml` & `create-fastapi-0.0.3/pyproject.toml`
...
### Comparing `create_fastapi-0.0.2/PKG-INFO` & `create-fastapi-0.0.3/PKG-INFO`
