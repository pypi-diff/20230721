# Comparing `tmp/NeuralFoil-0.1.6.tar.gz` & `tmp/NeuralFoil-0.1.7.tar.gz`
...
## Comparing `NeuralFoil-0.1.6.tar` & `NeuralFoil-0.1.7.tar`
...
### Comparing `NeuralFoil-0.1.6/LICENSE.txt` & `NeuralFoil-0.1.7/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/NeuralFoil.egg-info/PKG-INFO` & `NeuralFoil-0.1.7/README.md`
...
-neural network Classifier: Development Status :: 5 - Production/Stable
...
+data). NeuralFoil is available here as a pure Python+NumPy standalone, but it
+is also [available within AeroSandbox](#extended-features-transonics-post-
+stall-control-surface-deflections), which extends it with many more advanced
+features. Using the AeroSandbox extension, NeuralFoil can give you **viscous,
+compressible airfoil aerodynamics for (nearly) any airfoil, with control
+surface deflections, across $360^\circ$ angle of attack, at any Reynolds
+number, all nearly instantly** (~5 milliseconds). And, it's guaranteed to
+return an answer (no non-convergence issues), it's vectorized, and it's $C^1$-
+continuous (all very useful for gradient-based optimization). NeuralFoil is
+[~10x faster than XFoil for a single analysis, and ~1000x faster for multipoint
+analysis](#table), all with [minimal loss in accuracy compared to XFoil]
+(#performance). Due to the wide variety of training data and the embedding of
+several physics-based invariants, [this accuracy is seen even on out-of-sample
+airfoils](#performance) (i.e., airfoils it wasn't trained on). It also has
+[many nice features](#xfoil-benefit-question) (e.g., smoothness, vectorization,
+all in Python+NumPy) that make it much easier to use. NeuralFoil aims to be
+lightweight, with [minimal dependencies](#dependencies-question) and a [tight,
...
+predictions](#xfoil-benefit-question) (for example, near $C_L=1.4$ at
+$Re=\mathrm{90k}$) in cases where XFoil is not reliably converging, which would
...
+NeuralFoil to be more accurate in the subsonic range, where [XFoil is actually
...
### Comparing `NeuralFoil-0.1.6/NeuralFoil.egg-info/SOURCES.txt` & `NeuralFoil-0.1.7/NeuralFoil.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/PKG-INFO` & `NeuralFoil-0.1.7/NeuralFoil.egg-info/PKG-INFO`
...
### Comparing `NeuralFoil-0.1.6/README.md` & `NeuralFoil-0.1.7/PKG-INFO`
...
### Comparing `NeuralFoil-0.1.6/neuralfoil/CL_linear_regression.py` & `NeuralFoil-0.1.7/neuralfoil/CL_linear_regression.py`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/neuralfoil.py` & `NeuralFoil-0.1.7/neuralfoil/neuralfoil.py`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/nn_weights_and_biases/nn-large.npz` & `NeuralFoil-0.1.7/neuralfoil/nn_weights_and_biases/nn-large.npz`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/nn_weights_and_biases/nn-medium.npz` & `NeuralFoil-0.1.7/neuralfoil/nn_weights_and_biases/nn-medium.npz`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/nn_weights_and_biases/nn-small.npz` & `NeuralFoil-0.1.7/neuralfoil/nn_weights_and_biases/nn-small.npz`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/nn_weights_and_biases/nn-xlarge.npz` & `NeuralFoil-0.1.7/neuralfoil/nn_weights_and_biases/nn-xlarge.npz`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/nn_weights_and_biases/nn-xsmall.npz` & `NeuralFoil-0.1.7/neuralfoil/nn_weights_and_biases/nn-xsmall.npz`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/nn_weights_and_biases/nn-xxlarge.npz` & `NeuralFoil-0.1.7/neuralfoil/nn_weights_and_biases/nn-xxlarge.npz`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/nn_weights_and_biases/nn-xxsmall.npz` & `NeuralFoil-0.1.7/neuralfoil/nn_weights_and_biases/nn-xxsmall.npz`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/neuralfoil/nn_weights_and_biases/nn-xxxlarge.npz` & `NeuralFoil-0.1.7/neuralfoil/nn_weights_and_biases/nn-xxxlarge.npz`

 * *Files identical despite different names*

### Comparing `NeuralFoil-0.1.6/setup.py` & `NeuralFoil-0.1.7/setup.py`
