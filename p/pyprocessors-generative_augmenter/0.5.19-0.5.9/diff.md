# Comparing `tmp/pyprocessors_generative_augmenter-0.5.19.tar.gz` & `tmp/pyprocessors-generative_augmenter-0.5.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyprocessors_generative_augmenter-0.5.19.tar", last modified: Fri Jan  1 00:00:00 2016, max compression
...
## Comparing `pyprocessors_generative_augmenter-0.5.19.tar` & `pyprocessors-generative_augmenter-0.5.9.tar`

### file list

```diff
@@ -1,22 +1,19 @@
--rw-r--r--   0        0        0       97 2023-07-21 07:14:22.947893 pyprocessors_generative_augmenter-0.5.19/.dockerignore
--rw-r--r--   0        0        0      167 2023-07-21 07:14:22.947893 pyprocessors_generative_augmenter-0.5.19/.gitignore
--rw-r--r--   0        0        0      448 2023-07-21 07:14:22.947893 pyprocessors_generative_augmenter-0.5.19/Dockerfile
--rw-r--r--   0        0        0    10240 2023-07-21 07:14:22.948893 pyprocessors_generative_augmenter-0.5.19/Jenkinsfile
--rw-r--r--   0        0        0      380 2023-07-21 07:14:22.948893 pyprocessors_generative_augmenter-0.5.19/README.md
--rw-r--r--   0        0        0     1559 2023-07-21 07:14:22.949893 pyprocessors_generative_augmenter-0.5.19/bumpversion.py
--rw-r--r--   0        0        0       55 2023-07-21 07:35:21.470704 pyprocessors_generative_augmenter-0.5.19/pyprocessors_generative_augmenter/__init__.py
--rw-r--r--   0        0        0     5927 2023-07-21 07:14:22.950893 pyprocessors_generative_augmenter-0.5.19/pyprocessors_generative_augmenter/generative_augmenter.py
--rw-r--r--   0        0        0     2600 2023-07-21 07:14:22.950893 pyprocessors_generative_augmenter-0.5.19/pyproject.toml
--rw-r--r--   0        0        0        0 2023-07-21 07:14:22.950893 pyprocessors_generative_augmenter-0.5.19/tests/__init__.py
--rw-r--r--   0        0        0     2508 2023-07-21 07:35:18.430617 pyprocessors_generative_augmenter-0.5.19/tests/data/afp_slug_gold_fr-document-ner.json
--rw-r--r--   0        0        0     5004 2023-07-21 07:32:36.776011 pyprocessors_generative_augmenter-0.5.19/tests/data/afp_slug_gold_fr-document-test.json
--rw-r--r--   0        0        0     9161 2023-07-21 07:14:22.951893 pyprocessors_generative_augmenter-0.5.19/tests/data/jinjadocs.json
--rw-r--r--   0        0        0     3031 2023-07-21 07:14:22.952893 pyprocessors_generative_augmenter-0.5.19/tests/data/jinjadocs_en.json
--rw-r--r--   0        0        0    13529 2023-07-21 07:14:22.953893 pyprocessors_generative_augmenter-0.5.19/tests/data/jinjadocs_preserve_entities.json
--rw-r--r--   0        0        0    17884 2023-07-21 07:35:18.435618 pyprocessors_generative_augmenter-0.5.19/tests/data/jinjadocs_preserve_entities_augmented.json
--rw-r--r--   0        0        0    14427 2023-07-21 07:14:22.955893 pyprocessors_generative_augmenter-0.5.19/tests/data/jinjadocs_substitute_entities.json
--rw-r--r--   0        0        0    19309 2023-07-21 07:35:18.440618 pyprocessors_generative_augmenter-0.5.19/tests/data/jinjadocs_substitute_entities_augmented.json
--rw-r--r--   0        0        0     3135 2023-07-21 07:32:36.776011 pyprocessors_generative_augmenter-0.5.19/tests/test_generative_augmenter.py
--rw-r--r--   0        0        0      951 2023-07-21 07:14:22.957893 pyprocessors_generative_augmenter-0.5.19/tox.ini
--rw-r--r--   0        0        0     1348 1970-01-01 00:00:00.000000 pyprocessors_generative_augmenter-0.5.19/setup.py
--rw-r--r--   0        0        0     2498 1970-01-01 00:00:00.000000 pyprocessors_generative_augmenter-0.5.19/PKG-INFO
...
### Comparing `pyprocessors_generative_augmenter-0.5.19/Jenkinsfile` & `pyprocessors-generative_augmenter-0.5.9/Jenkinsfile`

 * *Files identical despite different names*

### Comparing `pyprocessors_generative_augmenter-0.5.19/bumpversion.py` & `pyprocessors-generative_augmenter-0.5.9/bumpversion.py`

 * *Files identical despite different names*

### Comparing `pyprocessors_generative_augmenter-0.5.19/pyprocessors_generative_augmenter/generative_augmenter.py` & `pyprocessors-generative_augmenter-0.5.9/pyprocessors_generative_augmenter/generative_augmenter.py`
...
### Comparing `pyprocessors_generative_augmenter-0.5.19/pyproject.toml` & `pyprocessors-generative_augmenter-0.5.9/pyproject.toml`
...
### Comparing `pyprocessors_generative_augmenter-0.5.19/tests/data/jinjadocs.json` & `pyprocessors-generative_augmenter-0.5.9/tests/data/jinjadocs.json`

 * *Files identical despite different names*

### Comparing `pyprocessors_generative_augmenter-0.5.19/tox.ini` & `pyprocessors-generative_augmenter-0.5.9/tox.ini`

 * *Files identical despite different names*

### Comparing `pyprocessors_generative_augmenter-0.5.19/setup.py` & `pyprocessors-generative_augmenter-0.5.9/setup.py`
...
### Comparing `pyprocessors_generative_augmenter-0.5.19/PKG-INFO` & `pyprocessors-generative_augmenter-0.5.9/PKG-INFO`
