# Comparing `tmp/st_circular_progress-0.2.6.tar.gz` & `tmp/st_circular_progress-0.2.7.tar.gz`
...
## Comparing `st_circular_progress-0.2.6.tar` & `st_circular_progress-0.2.7.tar`
...
### Comparing `st_circular_progress-0.2.6/LICENSE` & `st_circular_progress-0.2.7/LICENSE`

 * *Files identical despite different names*

### Comparing `st_circular_progress-0.2.6/setup.py` & `st_circular_progress-0.2.7/setup.py`
...
### Comparing `st_circular_progress-0.2.6/st_circular_progress/__init__.py` & `st_circular_progress-0.2.7/st_circular_progress/__init__.py`
