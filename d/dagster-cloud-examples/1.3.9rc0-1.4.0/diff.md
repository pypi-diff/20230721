# Comparing `tmp/dagster_cloud_examples-1.3.9rc0.tar.gz` & `tmp/dagster_cloud_examples-1.4.0.tar.gz`
...
## Comparing `dagster_cloud_examples-1.3.9rc0.tar` & `dagster_cloud_examples-1.4.0.tar`
...
### Comparing `dagster_cloud_examples-1.3.9rc0/README.md` & `dagster_cloud_examples-1.4.0/README.md`

 * *Files identical despite different names*

### Comparing `dagster_cloud_examples-1.3.9rc0/dagster_cloud_examples/cereals/jobs/compute_cereal_properties/ops/__init__.py` & `dagster_cloud_examples-1.4.0/dagster_cloud_examples/cereals/jobs/compute_cereal_properties/ops/__init__.py`

 * *Files identical despite different names*

### Comparing `dagster_cloud_examples-1.3.9rc0/dagster_cloud_examples.egg-info/SOURCES.txt` & `dagster_cloud_examples-1.4.0/dagster_cloud_examples.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `dagster_cloud_examples-1.3.9rc0/setup.py` & `dagster_cloud_examples-1.4.0/setup.py`
