# Comparing `tmp/dagster-airflow-1.3.9rc0.tar.gz` & `tmp/dagster-airflow-1.4.0.tar.gz`
...
### Comparing `dagster-airflow-1.3.9rc0/LICENSE` & `dagster-airflow-1.4.0/LICENSE`
